...
Config.Garages = {
    ...
    ['police'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(425.3, -1030.38),
                vector2(424.59, -1022.12),
                vector2(446.88, -1021.33),
                vector2(448.11, -1028.31),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(427.13, -1026.77, 28.73, 5.68),
            vector4(431.1, -1026.95, 28.67, 5.18),
            vector4(434.99, -1026.4, 28.6, 6.35),
            vector4(438.72, -1025.89, 28.52, 5.79),
            vector4(442.46, -1025.22, 28.44, 6.68),
            vector4(445.84, -1024.84, 28.38, 4.72),

            -- parking spot with doors
            vector4(463.31, -1019.55, 27.7, 91.98),
            vector4(463.2, -1014.6, 27.68, 90.91),
