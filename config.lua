--[[
 ...
 -- NEW --
StoreDamageAccuratly = false -- if set to true, make sure to apply / run patch1.sql
...
Garages = {
    ...
    ['RangerStation'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(371.98, 800.78),
            vector2(376.63, 800.82),
            vector2(376.65, 781.9),
            vector2(370.25, 782.47),
            },
            ['minZ'] = 184.0,  -- min height of the parking zone
            ['maxZ'] = 188.0,  -- max height of the parking zone
        },
        label = 'Ranger Station Garage',
        type = 'job',
        job = "police",
        vehicleCategories = {'emergency'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(373.98, 789.83, 187.18, 147.37),
        },
        debug = false
    },
    ['pdgarage2'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-575.84, -83.35),
            vector2(-563.95, -113.04),
            vector2(-614.27, -135.23),
            vector2(-626.97, -105.09),
            },
        ...
        debug = false,
        ["ParkingSpots"] = {
            vector4(-576.65, -86.31, 33.75, 201.54),
            vector4(-580.34, -87.78, 33.75, 206.31),
            vector4(-583.56, -89.1, 33.75, 204.46),
            vector4(-589.15, -92.52, 33.75, 201.16),
            vector4(-592.99, -93.15, 33.75, 206.37),
            vector4(-596.45, -94.35, 33.75, 203.92),
            vector4(-599.35, -95.55, 33.75, 204.28),
            vector4(-602.79, -96.61, 33.75, 204.32),
            vector4(-605.71, -98.08, 33.75, 203.26),
            vector4(-609.06, -99.92, 33.75, 201.88),
            vector4(-615.32, -102.85, 33.75, 201.81),
            vector4(-618.82, -103.96, 33.75, 201.31),
            vector4(-622.21, -105.34, 33.75, 203.76),
            vector4(-625.2, -106.68, 33.75, 201.4),
            vector4(-613.73, -132.33, 33.75, 21.61),
            vector4(-610.77, -131.29, 33.75, 21.92),
            vector4(-607.79, -129.75, 33.75, 21.1),
            vector4(-604.31, -128.47, 33.75, 21.91),
            vector4(-601.39, -127.39, 33.75, 21.75),
            vector4(-598.15, -126.02, 33.75, 21.35),
            vector4(-594.98, -124.73, 33.75, 24.11),
            vector4(-605.51, -118.72, 33.75, 201.98),
            vector4(-602.42, -117.33, 33.75, 196.62),
            vector4(-599.14, -115.96, 33.75, 202.48),
            vector4(-595.82, -114.32, 33.75, 201.83),
            vector4(-592.51, -113.33, 33.75, 194.96),
            vector4(-589.65, -111.61, 33.75, 204.85),
            vector4(-586.74, -110.28, 33.75, 204.02),
            vector4(-583.3, -108.72, 33.75, 201.42),
            vector4(-580.24, -107.76, 33.75, 201.81),
            vector4(-582.5, -101.95, 33.75, 20.86),
            vector4(-585.58, -103.22, 33.75, 19.06),
            vector4(-588.93, -104.57, 33.75, 21.98),
            vector4(-591.96, -105.85, 33.75, 20.95),
            vector4(-595.01, -107.38, 33.75, 21.42),
            vector4(-598.03, -108.75, 33.75, 17.15),
            vector4(-601.21, -109.91, 33.75, 21.08),
            vector4(-604.5, -111.29, 33.75, 26.89),
            vector4(-607.71, -112.41, 33.75, 21.93),
        },
    },
    ['ppdgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-478.51940917969, 6014.9448242188),
                vector2(-488.18746948242, 6024.576171875),
                vector2(-461.16882324219, 6051.5966796875),
                vector2(-450.45513916016, 6041.3510742188),
                vector2(-464.73089599609, 6026.7182617188),
                vector2(-462.00796508789, 6023.9741210938),
                vector2(-457.0461730957, 6019.2802734375),
                vector2(-470.22213745117, 6006.5009765625)
            },
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-483.04, 6025.08, 31.15, 44.82),
            vector4(-479.68, 6028.6, 31.15, 45.97),
            vector4(-476.27, 6031.97, 31.15, 44.27),
            vector4(-472.48, 6035.72, 31.15, 44.5),
            vector4(-469.28, 6038.9, 31.15, 46.86),
            vector4(-460.41, 6047.9, 31.15, 316.7),
            vector4(-457.34, 6044.49, 31.15, 317.63),
            vector4(-454.38, 6041.35, 31.15, 314.68),
        },
        debug = false
    },
    --gang garages
    ['Saints'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-769.378296, -44.470406),
            vector2(-740.251770, -28.813278),
            vector2(-742.088013, -24.791899),
            vector2(-771.039856, -39.775875),
            },
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-746.9, -30.1, 37.69, 125.17),
            vector4(-752.72, -33.37, 37.69, 126.13),
            vector4(-757.35, -35.9, 37.69, 117.0),
            vector4(-763.44, -39.0, 37.69, 116.96),
        },
        debug = false
    },
    ['Triads'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-757.74, -922.51),
            vector2(-842.86, -905.52),
            vector2(-839.47, -851.68),
            vector2(-758.33, -856.8),
            },
            ['minZ'] = 17.0,  -- min height of the parking zone
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-761.4, -905.87, 19.76, 276.55),
            vector4(-760.99, -894.61, 20.49, 271.36),
            vector4(-760.84, -897.39, 20.3, 262.67),
            vector4(-760.67, -900.18, 20.11, 267.96),
            vector4(-761.41, -903.15, 19.93, 271.04),
            vector4(-779.89, -870.42, 20.69, 85.12),
            vector4(-779.68, -874.42, 20.69, 81.96),
            vector4(-779.73, -878.18, 20.69, 88.96),
            vector4(-810.12, -885.47, 20.73, 0.97),
            vector4(-806.03, -885.57, 20.73, 3.62),
            vector4(-801.9, -884.37, 20.69, 2.08),
            vector4(-798.31, -883.22, 20.69, 2.15),
            vector4(-807.67, -898.47, 18.91, 85.8),
            vector4(-807.2, -894.61, 18.92, 87.14),
            vector4(-807.19, -890.99, 18.92, 89.6),
        },
        debug = false
    },
    ['The Ineffable'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-667.229919, -865.957764),
            vector2(-656.175903, -865.971558),
            vector2(-655.957336, -873.822144),
            vector2(-667.233215, -874.404114),
            },
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-659.23, -869.21, 24.51, 181.22),
            vector4(-663.45, -869.16, 24.51, 180.04),
        },
        debug = false
    },
--Bussiness Garges
['Dynasty 8'] = {
    ['Zone'] = {
        ['Shape'] = { --polygon that surrounds the parking area
        vector2(-704.81, 276.89),
        vector2(-717.71, 278.14),
        vector2(-715.17, 271.77),
        },
        ['minZ'] = 83.0,  -- min height of the parking zone
        ['maxZ'] = 85.0,  -- max height of the parking zone
    },
    label = 'Dynasty 8',
    type = 'job',
    job = "realestate",
    ...
    drawText = 'Parking',
    ["ParkingSpots"] = {
        vector4(-715.18, 274.48, 84.6, 293.36),
    },
    debug = false
},
}
